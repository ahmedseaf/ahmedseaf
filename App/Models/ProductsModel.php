...
class ProductsModel extends Model
{
    ...
    public function productFave()
    {
        if(isset($_POST['product_value'])  AND ($_POST['product_value']) == 'true')
        {
            // Set Product To Favorite
             $this->query('UPDATE products  SET fave=? WHERE id=? ','on', $_POST['productID']);
        } else {
            // Remove Product From Favorite
             $this->query('UPDATE products  SET fave=? WHERE id=? ','', $_POST['productID']);
        }
    }
